#!/usr/bin/env python3
"""
Simple runner script for Sparse R-CNN cache generation.

This script generates cache files from Sparse R-CNN checkpoints using the standard 
Detectron2 cache generation pipeline.
"""
...
def main():
    """Main function to run Sparse R-CNN cache generation with provided paths."""
    print("="*80)
    print("SPARSE R-CNN CACHE GENERATION SCRIPT")
    print("="*80)
    ...
    config_path = None  # Auto-determined from checkpoint name
    ...
    try:
        from scripts.generate_cache import CacheGenerator
        ...
        print(f"\nGenerating Sparse R-CNN cache with configuration:")
        ...
        print("\nSparse R-CNN cache generation completed successfully!")
        return 0
